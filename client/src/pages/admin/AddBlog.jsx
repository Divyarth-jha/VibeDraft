...
const AddBlog = () => {
  ...
  if (!title) return toast.error("Please enter blog title first!");
    ...
    try{ 
      ...
      setIsAdding(true);
       const blog = {
         ...
         subTitle,
         category,
         isPublisehd: isPublished, // 👈 match backend spelling
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <div className='flex gap-2 mt-4'>
          <p className={`${isPublished == true ?'text-green-700':'text-gray-500'}`}>Publiched Now</p>
          <input
